...
export function ProfileView() {
  // Dados fictícios para substituir a chamada useStudent()
  const student = {
    name: "Afonso Miguel Santos",
    email: "afonso.santos@ficticio.edu",
    class: "10º B",
    enrollmentNumber: "20230915",
    year: "2023/2024",
    studentId: "987654321"
  };
  ...
  // Calculate age from a fictitious birth date
  const birthDate = new Date('2007-05-20'); // Data de nascimento fictícia
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Perfil do Encarregado</h1>
